...
from src.langgraphagenticai.nodes.requirement_analyzer import requirement_analysis_node
from nodes.user_story_generator import user_story_generator_node
from nodes.design_document_generator import design_document_generator_node
...
def create_sdlc_graph(llm: Any, vectorstore: Any):
    ...
    async def requirements_node(state: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            state = await requirement_analysis_node(state)
            return state
    ...
    async def user_stories_node(state: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            state = await user_story_generator_node(state)
            return state
        except Exception as e:
    ...
    async def user_stories_feedback_node(state: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            state = await user_stories_feedback_node(state, llm, vectorstore)
            return state
        except Exception as e:
    ...
    async def design_node(state: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            state = await user_story_generator_node(state, llm, vectorstore)
            return state
        except Exception as e:
    ...
    async def design_feedback_node(state: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            state = await design_feedback_node(state, llm, vectorstore)
            return state
        except Exception as e:
